...
const teamMembers = [
  ...
  },
  {
    ...
    bio: 'Driving business growth and leading strategic operations for the team.',
    email: undefined,
    linkedin: undefined,
  ...
  {
    name: 'Ranjith NB',
    role: 'ASST. BUSINESS HEAD',
    title: 'Assistant Business Head & Full Stack Developer',
    skills: ['Web Development', 'API Integration', 'Problem Solving'],
    bio: 'Supporting business growth and full stack development initiatives.',
    email: undefined,
    linkedin: undefined,
  ...
  },
  {
    ...
    email: undefined,
    linkedin: undefined,
    image: '/team/photos/priyanka.jpg',
    accent: 'from-red-500 to-rose-100',
  },
  {
    name: 'Devv Sharann S',
    ...
    email: undefined,
    linkedin: undefined,
    image: '/team/photos/devv-sharann.jpg',
    accent: 'from-red-400 to-zinc-100',
  },
  {
    name: 'Keerthi Ratna',
