...
const initialTeams: Team[] = [
  {
    ...
    color: 'red',
    members: [
      { id: 't1m1', name: 'Dev Dharrshan', points: 0 },
      { id: 't1m2', name: 'Avaneesh', points: 0 },
      { id: 't1m3', name: 'Anusree', points: 0 },
      { id: 't1m4', name: 'Ridhesha', points: 0 },
      { id: 't1m5', name: 'Ranjith', points: 0 },
      { id: 't1m6', name: 'Rhea', points: 0 },
      { id: 't1m7', name: 'Manju Shri', points: 0 },
      { id: 't1m8', name: 'Gokul Shankar', points: 0 },
    ],
  },
  {
    id: 'team2',
    ...
    color: 'blue',
    members: [
      { id: 't2m1', name: 'Aishwarya', points: 0 },
      { id: 't2m2', name: 'Arvind', points: 0 },
      { id: 't2m3', name: 'Divya Dharshini', points: 0 },
      { id: 't2m4', name: 'Prakalya', points: 0 },
      { id: 't2m5', name: 'Roshini', points: 0 },
      { id: 't2m6', name: 'Dhavanithi', points: 0 },
      { id: 't2m7', name: 'Pushparajan', points: 0 },
      { id: 't2m8', name: 'gokulavarshini', points: 0 },
    ],
  },
]
